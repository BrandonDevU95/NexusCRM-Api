...
un hecho o compromiso de seguimiento; una tarea ejecutable pertenece al módulo 10. No crees una tabla `timelines`: el timeline es una consulta sobre fuentes
existentes.
